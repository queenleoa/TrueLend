...
Six contracts, ~1,600 lines of Solidity 0.8.26: `TrueLendHook` (lending core + engine, 24,444 bytes — 132 under the EIP-170 limit), `LendingVault` ×2 per pool, `VaultFactory`, and libraries `LiqRangeMath`, `ChunkMath`, `TruncatedOracle`, `TriggerIndex` (all four deployed as linked external libraries). Any pool initialized with the hook — ERC-20 pairs or native-ETH pools, the latter WETH-bridged at the hook boundary — becomes a lending market automatically. 86 tests: fuzzed unit tests for all math, vault accounting and waterfall tests, 28 full-lifecycle integration scenarios plus 4 native-ETH pool scenarios (including LT-99 leverage, manipulation rejection, drained-pool backstop, and a 6-vs-18-decimals pair), and randomized invariant tests.

**Deployment (Unichain Sepolia, chain 1301):** TrueLendHook `0xCD52d3f33DAf64aBE879DA38F0e55a280fc450c0` · VaultFactory `0x1C4E9f5b89e096c98592a304f4aF8DDc529fA057` · against canonical PoolManager `0x00B036B58a818B1BC34d502D3fE730Db729e62AC`.
